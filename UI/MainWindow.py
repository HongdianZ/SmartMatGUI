...
################################################################################
## Form generated from reading UI file 'GUIxuQTzj.ui'
##
...
"background-color: rgb(0, 0, 50);")
        ...
        self.PressureDisplay = QGraphicsView(self.ContentMiddle)
...
"background-color: rgb(0, 0, 50);")
        ...
        sizePolicy4.setHeightForWidth(self.posture_label.sizePolicy().hasHeightForWidth())
        self.posture_label.setSizePolicy(sizePolicy4)
        font6 = QFont()
        ...
        sizePolicy4.setHeightForWidth(self.AIResult.sizePolicy().hasHeightForWidth())
        self.AIResult.setSizePolicy(sizePolicy4)
        font7 = QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.AIResult.setText(QCoreApplication.translate("MainWindow", u"   Lay Down", None))
